...
mixin _$TodoStatsResponse {
 ...
 int get complete; int get in_progress;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodoStatsResponse&&(identical(other.complete, complete) || other.complete == complete)&&(identical(other.in_progress, in_progress) || other.in_progress == in_progress));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,complete,in_progress);

@override
String toString() {
  return 'TodoStatsResponse(complete: $complete, in_progress: $in_progress)';
}
...
/// Create a copy of TodoStatsResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? complete = null,Object? in_progress = null,}) {
...
class _TodoStatsResponse implements TodoStatsResponse {
  const _TodoStatsResponse({required this.complete, required this.in_progress});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TodoStatsResponse&&(identical(other.complete, complete) || other.complete == complete)&&(identical(other.in_progress, in_progress) || other.in_progress == in_progress));
}
...
/// Create a copy of TodoStatsResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? complete = null,Object? in_progress = null,}) {
